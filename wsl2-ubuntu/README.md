...
This directory contains package inventories and configuration required to rebuild the Linux development environment used alongside Windows.
...
Windows serves as the desktop environment. WSL2 Ubuntu serves as the Linux execution environment. Both environments should be capable of supporting development workflows independently.
